...
namespace IEC60870_5_104_simulator.Infrastructure.Interfaces
{
    public interface IInformationObjectTemplate
    {
        ...
        InformationObject GetMeasuredValueNormalized(int objectAddress, IecValueFloatObject iecValueShortObject, Iec104DataTypes iec104DataType);
        InformationObject GetMeasuredValueScaled(int objectAddress, IecValueScaledObject iecScaled, Iec104DataTypes iec104DataType);
        InformationObject GetMeasuredValueShort(int objectAddress, IecValueFloatObject iecValueShortObject, Iec104DataTypes iec104DataType);
